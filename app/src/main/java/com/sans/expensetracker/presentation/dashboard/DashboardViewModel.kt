package com.sans.expensetracker.presentation.dashboard
...
data class DashboardState(
    ...
    val recentTransactions: List<com.sans.expensetracker.domain.model.Expense> = emptyList(),
    val upcomingBills: List<com.sans.expensetracker.domain.model.Expense> = emptyList(),
    val goals: List<com.sans.expensetracker.data.local.entity.GoalEntity> = emptyList(),
