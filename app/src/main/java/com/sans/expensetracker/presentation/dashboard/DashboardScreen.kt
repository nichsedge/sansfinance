...
@Composable
fun DashboardGoalItem(goal: com.sans.expensetracker.data.local.entity.GoalEntity) {
...
@Composable
fun DashboardBillItem(bill: com.sans.expensetracker.domain.model.Expense) {
    Card(
        modifier = Modifier.fillMaxWidth(),
